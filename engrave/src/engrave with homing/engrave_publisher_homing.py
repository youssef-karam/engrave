...
"""
version = '11'
fontfile = "/home/youssef/catkin_ws/src/caligraphy_robot/engrave/cxf-fonts/FONTS/simplex.cxf"
...
#=======================================================================
    def DoIt(self):
        ...
        if self.flag == 0 :
            ...
            self.gcode.append("G0 Y-30")    # Y-axis offset
        self.gcode.append("G92 x0 y0 z0")
        ##############################################################################
        self.gcode.append("$X")
...
#                    self.gcode.append("(%f,%f to %f,%f)" %(stroke.xstart,stroke.ystart,stroke.xend,stroke.yend ))
        ...
        self.gcode.append('G0 z0') 
        self.gcode.append("G0 x0 y-30 z0")
